...
# Cases as Outliers: 5448,5449,5450,5451,3467

# Panel Regression without Outliers
x <- dtFull[!(dtFull$inflatavg>300),]
probdf <-  pdata.frame(x[-c(5448,5449,5450,5451,3467,212,213)],
                       index = c("country","year"))
pronmod1.1 <- plm(v2csanmvch_9 ~ inflatavg * popDensity + debtm1 + ctrySize
